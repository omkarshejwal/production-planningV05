...
class BottleConfiguration(Base):
    ...
    machine_no = Column(Integer, ForeignKey("machine_master.machine_no"), primary_key=True)
    bottle_id = Column(Integer, ForeignKey("bottle_master.bottle_id"), primary_key=True)
